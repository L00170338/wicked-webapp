...
============
We choosed amazon cloud watch monitoring because Amazon ECS service using the Fargate launch type is enabled for CloudWatch CPU and memory utilization metrics automatically.
