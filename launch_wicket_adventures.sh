...
os_packages="git python3.9 python3.9-venv python3.9-dev python3-pip python3-wheel "
...
python3.9 -m venv venv && source venv/bin/activate && python3.9 manage.py runserver --insecure 0.0.0.0:8000
